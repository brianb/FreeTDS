...
static char software_version[] = "$Id: error.c,v 1.1 2004/03/30 15:14:12 freddy77 Exp $";
...
main(int argc, char *argv[])
{
	...
	/* issue our command */
	if (CommandWithResult(Statement, "select 100 / (i - 5) from #tmp order by i") != SQL_SUCCESS)
