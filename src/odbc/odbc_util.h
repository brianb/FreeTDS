...
static char rcsid_odbc_util_h[] = "$Id: odbc_util.h,v 1.16 2003/08/29 20:37:48 freddy77 Exp $";
...
char *odbc_tds_to_sql_typename(int col_type, int col_size, int odbc_ver);
...
SQLINTEGER odbc_get_param_len(struct _drecord *drec);
