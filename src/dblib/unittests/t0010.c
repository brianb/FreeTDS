/* 
 * Purpose: Test to see if dbbind can handle a varlen of 0 with a column bound as STRINGBIND and a database column of VARCHAR.
 * Functions: dbbind dbnextrow dbopen dbresults dbsqlexec 
 */
