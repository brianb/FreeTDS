...
TDS_RCSID(var, "$Id: dblib.c,v 1.271 2007/01/16 08:49:11 freddy77 Exp $");
				...
				int bindtype, DBSMALLINT *indicator)
{
	...
	CHECK_PARAMETER_RETVOID(src, SYBENULP);
	CHECK_PARAMETER_RETVOID(dest, SYBENULP);
